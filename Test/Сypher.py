...
def prepare_data(
    ...
    print(f"BROKER_ACCOUNT_ID={broker_account_id}")
    ...
    encrypted_broker_account_id = encrypt(broker_account_id, key)
    ...
    print(f"BROKER_ACCOUNT_ID={encrypted_broker_account_id}")
    ...
    decrypted_broker_account_id = decrypter.decrypt(encrypted_broker_account_id)
    ...
    print(f"BROKER_ACCOUNT_ID={decrypted_broker_account_id}")
...
if __name__ == "__main__":
    prepare_data(
        ...
        broker_account_id=test_broker_account_id,
